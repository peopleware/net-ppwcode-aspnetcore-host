# PPWCode.AspNetCore.Host

This library is part of the .NET PPWCode project and serves as the base for the Host project in a REST API solution implemented with ASP.NET Core.
